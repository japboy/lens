//! Explicit observation geometry. Validation correlates owned facts, not atomic scenes.
use crate::authority::{TargetAuthority, TargetReadKey};
...
mod tests {
    ...
    use crate::authority::ReadSequence;
