        ...
        if (change.type === "delete" || change.type === "reset_all") {
          const approved = await this.port.confirmAction(
            change.type === "delete"
              ...
              : "Reset all presets? All added presets, saved edits and unsaved drafts will be deleted. The three initial presets will be restored and Conceptual will be used.",
