...
describe("CI impact classification", () => {
  it.each([
    ...
    [["scripts/workspace-policy.ts"], "native-or-control-plane"],
    [["scripts/check-workspace-boundaries.ts"], "native-or-control-plane"],
    [["scripts/rust-source-boundaries.ts"], "native-or-control-plane"],
    [["scripts/workspace-boundaries.test.ts"], "native-or-control-plane"],
    [["scripts/workspace-feature-graphs.ts"], "native-or-control-plane"],
    [["scripts/workspace-feature-graphs.test.ts"], "native-or-control-plane"],
    [["scripts/rust-source-surface.ts"], "native-or-control-plane"],
    [["scripts/rust-source-surface.test.ts"], "native-or-control-plane"],
    [["scripts/run-workspace-variant.ts"], "native-or-control-plane"],
    [["scripts/run-workspace-variant.test.ts"], "native-or-control-plane"],
    [["scripts/workspace-variants.json"], "native-or-control-plane"],
    [["scripts/check-portable-native-features.ts"], "native-or-control-plane"],
    [["scripts/check-portable-native-features.test.ts"], "native-or-control-plane"],
